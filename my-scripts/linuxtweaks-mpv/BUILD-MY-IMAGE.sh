...
cp /home/tolga/Documents/MEGA/Documents/LINUX/fedora/RPM-BIILD/FINAL/linuxtweaks-mpv/AppDir/usr/share/icons/hicolor/256x256/apps/LT.png "$APPDIR_PATH/usr/share/icons/hicolor/256x256/apps/$APP_NAME.png"
...
case "$Kernel" in
    ...
    *)        echo "⚠️ Unsupported Operating System: $Kernel"; exit 1 ;;
esac
...
case "$Architecture" in
    ...
    *)        echo "⚠️ Unsupported Architecture: $Architecture"; exit 1 ;;
esac

# Output Architecture Information
echo -e "Operating System Architecture: $Architecture\n"
